...
| Nguyễn Minh Ngọc | 2A202602530 | ngocnm | Thiết kế bộ 10 test case nhóm (eval_group.json) 5 đơn lượt + 5 nhiều lượt, Tối ưu hóa tools.yaml | data/eval_group.json, artifacts/tools.yaml |
