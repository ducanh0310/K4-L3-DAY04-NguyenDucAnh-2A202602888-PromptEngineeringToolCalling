...
| Nguyễn Minh Ngọc | 2A202602530 | nguyenminhngoc234it-gif | Thiết kế bộ 10 test case nhóm (eval_group.json) 5 đơn lượt + 5 nhiều lượt, Tối ưu hóa tools.yaml | data/eval_group.json, artifacts/tools.yaml |
| Đồng Mạnh Hùng | 2A202602412 | Hung23020370 | Đánh giá an toàn & bảo mật dữ liệu (eval_adversarial.json), Viết báo cáo kỹ thuật REPORT.md | data/eval_adversarial.json, artifacts/REPORT.md |
